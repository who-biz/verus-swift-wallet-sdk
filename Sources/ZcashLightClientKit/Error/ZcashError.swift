...
public enum ZcashError: Equatable, Error {
    ...
    /// ZDRVT0002
    case derivationToolEncryptAddressInvalidLength
    ...
    /// Invalid data length for encryption or decryption
    /// ZDRVT0004
    case derivationToolEncryptionDataInvalidLength
    ...
    public var message: String {
        ...
        case .rustDeriveShieldedAddress: return "Unable to derive shielded address from ufvk when calling ZcashRustBackend.deriveShieldedAddress"
        case .rustDeriveSaplingSpendingKey: return "Unable to derive sapling spending key from seed when calling ZcashRustBackend.deriveSaplingSpendingKey"
        ...
        case .derivationToolEncryptionAddressInvalidIndex: return "An invalid value for either hdIndex or encryptionIndex was used when deriving EncryptionAddress"
        case .derivationToolEncryptAddressInvalidLength: return "An invalid length for Address bytes was used when calling encryptVerusData"
        case .derivationToolEncryptionDataInvalidLength: return "An invalid length for encryption/decryption data was used when calling encryptVerusData or decryptVerusData"
        case .rustGetEncryptionAddress: return "Something went wrong when calling Rust for getEncryptionAddress"
        case .rustEncryptVerusData: return "Something went wrong when calling Rust for encryptVerusData"
        case .rustDecryptVerusData: return "Something went wrong when calling Rust for decryptVerusData"
        }
    }
    ...
    public var code: ZcashErrorCode {
        ...
        case .rustDeriveShieldedAddress: return .rustDeriveShieldedAddress
        case .rustDeriveSaplingSpendingKey: return .rustDeriveSaplingSpendingKey
